...
import PolicyScreen from '../Information/PolicyScreen';
import PregnantPolicyScreen from '../Information/PregnantPolicyScreen';

const Tab = createMaterialTopTabNavigator();

const PolicyTopTab = ({navigation}) => {
  ...
  return (
    <>
      ...
      <Tab.Navigator
        ...
        <Tab.Screen
          name="type1"
          component={PregnantPolicyScreen}
          options={{tabBarLabel: '출산'}}
        />
        <Tab.Screen
          name="type2"
          component={PolicyScreen}
          options={{tabBarLabel: '근로'}}
        />
      </Tab.Navigator>
    </>
  );
