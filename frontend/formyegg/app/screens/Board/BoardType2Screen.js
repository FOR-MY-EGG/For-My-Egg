  ...
  return (
    <View
      ...
      <View style={{flexDirection: 'row', justifyContent: 'center', alignItems: 'center'}}>
        <Text style={styles.titleText}>육아 정보! 🎉</Text>
        <TouchableOpacity onPress={() => navigation.navigate('Write',{affiliation: 1})}>
          <Image style={styles.button} source={{ uri: "https://formyegg-bucket.s3.ap-northeast-2.amazonaws.com/write.png" }}></Image>
        </TouchableOpacity>
      </View>
        <TouchableOpacity  onPress={() => navigation.navigate('Chat',{affiliation: 1})}>
      ...
      <FlatList data={cards} keyExtractor={(_) => _.title} style={styles.container} 
          ...
          const { title, content } = item;
            return (
              ...
              view={item.view} profile="https://formyegg-bucket.s3.ap-northeast-2.amazonaws.com/6609596.png"/>
            )
        }} 
