    ...
    <View
      ...
      <View
        ...
        <Button
          ...
          icon="pencil"
          mode="elevated"
          onPress={() => navigation.navigate('Write', {affiliation: 2})}>
          글 작성
        </Button>
        <Button
          textColor="white"
          ...
          onPress={() => navigation.navigate('Chat', {affiliation: 2})}>
          채팅
        </Button>
      </View>
      <FlatList
        ...
        renderItem={({item}) => {
          ...
          return (
            <CardComponent
              ...
              view={item.view}
              profile="https://formyegg-bucket.s3.ap-northeast-2.amazonaws.com/222.jpeg"
            />
          );
        }}
