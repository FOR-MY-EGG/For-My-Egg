 ...
 import com.shinhan.formyegg.api.SingleResponse;
 ...
 public class ChatController {
     ...
     public ResponseEntity<SingleResponse> getChatRoomsByMemberNo(@PathVariable int affiliation) {
         return ResponseEntity.ok().body(responseService.getSingleResponse(chatService.findChatsByAffiliation(affiliation)));
     }
 }
